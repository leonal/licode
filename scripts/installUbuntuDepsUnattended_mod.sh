...
install_openssl(){
  if [ -d $LIB_DIR ]; then
    ...
    cp $THIRD_DIR/openssl-1.0.1g.tar.gz $LIB_DIR
...
install_libnice(){
  if [ -d $LIB_DIR ]; then
    ...
    cp $THIRD_DIR/libnice-0.1.4.tar.gz $LIB_DIR
...
install_opus(){
  ...
  cp $THIRD_DIR/opus-1.1.tar.gz $LIB_DIR
...
install_mediadeps(){
  ...
  if [ -d $LIB_DIR ]; then
    ...
    cp $THIRD_DIR/libav-11.1.tar.gz $LIB_DIR
